...
internal object Config {
    ...
    const val TESSERACT_DATA_PATH = "/opt/homebrew/share/tessdata"//""C:\\Program Files\\Tesseract-OCR\\tessdata"
    ...
    const val CHUNK_SIZE_TOKENS = 1000
    const val CHUNK_OVERLAP_TOKENS = 250
